        ...
        var EdgeVisualization = (function () {
            ...
            EdgeVisualization.prototype.getInitialControlPoint = function (startPoint, endPoint) {
                ...
                switch (this.pathMode) {
                    ...
                    case 2 /* OPPOSING_A */:
                    case 3 /* OPPOSING_B */:
                        controlPoint.add(jsflap.Point.MPoint.getNormalOffset(startPoint, endPoint, 20));
                        break;
                }
                return controlPoint;
            };
        ...
        var VisualizationCollection = (function () {
            ...
            VisualizationCollection.prototype.update = function () {
                ...
                edgePathControlPoints.enter().append('circle').classed('control', true).attr('r', 10).on('mousedown', function (edge) {
                    ...
                    if (_this.state.mode === 1 /* MOVE */) {
                        ...
                        edgePaths.transition().duration(750).ease('elastic').attr('d', function (d) { return d.getPath(); });
                        edgeTransitions.transition().duration(750).ease('elastic').attr('x', function (d) { return d.visualization.getTransitionPoint(d.visualizationNumber).x; }).attr('y', function (d) { return d.visualization.getTransitionPoint(d.visualizationNumber).y; });
                        edgePathControlPoints.transition().ease('elastic').duration(750).attr('cx', function (d) { return d.control.x; }).attr('cy', function (d) { return d.control.y; }).each('end', function () {
                            _this.update();
                        });
                    }
            ...
            VisualizationCollection.prototype.editTransition = function (edge, node) {
                ...
                function updateTransition() {
                    ...
                    var similarTransitions = edge.visualization.models.edges.filter(function (otherEdge) { return otherEdge.transition.toString() === transition.toString(); });
                        ...
                        if (!this.state.ctrlKeyPressed) {
                            ...
                            updateFn = function (edgeModel) {
                                ...
                                if (edgeV.hasMovedControlPoint() && edgeV.pathMode !== 1 /* SELF */) {
                                    ...
                                    offset = jsflap.Point.MPoint.getNormalOffset(newDraggingNodePoint, newMidpoint, initialDistance, theta3);
